<script lang="ts">
	...
	// Landing is intentionally minimal for the MVP. A public directory of
	// tournaments can be added once the list endpoint exists. For now it points
	// visitors at a tournament by slug.
</script>
