...
<div class="mb-6 flex flex-wrap items-center justify-between gap-3">
	<div>
		<h1 class="font-display text-2xl uppercase tracking-[0.08em] text-primary">Overview</h1>
...
<!-- Recent tournaments -->
<h2 class="mb-3 font-display text-[15px] uppercase tracking-[0.08em] text-primary">Recent</h2>
